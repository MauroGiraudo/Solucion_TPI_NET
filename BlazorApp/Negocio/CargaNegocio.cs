...
namespace BlazorApp.Negocio
{
    public class CargaNegocio
    {
        ...
        public static CargaMuestra SetOneCargaMuestra(Carga carga)
        {
            CargaMuestra cargaMuestra = new CargaMuestra
            {
                IdOperacion = carga.IdOperacion,
                FechaOperacion = carga.FecOperacion,
                EstadoOperacion = carga.EstadoOperacion
            };
            return cargaMuestra;
        }
