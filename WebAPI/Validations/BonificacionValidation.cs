...
namespace WebAPI.Validations
{
    public class BonificacionValidation
    {
        public static string? Parse(BonificacionService service, Bonificacion bonificacion)
        {
            ...
            {
                if(bonificacion.IdBonificacion != b.IdBonificacion && bonificacion.ProporcionDescuento == b.ProporcionDescuento)
                {
                    return "Ya existe una bonificación con el porcentaje de descuento ingresado";
                }
                if (bonificacion.IdBonificacion != b.IdBonificacion && bonificacion.CantidadParaDescuento == b.CantidadParaDescuento && bonificacion.FecVigenciaBonificacion.Date == b.FecVigenciaBonificacion.Date)
                {
